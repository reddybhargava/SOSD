#ifndef SOSDB_PGMCACHELO_H
#define SOSDB_PGMCACHELO_H
...
#include <iostream>
#include <algorithm>
#include "pgm_index_cache_lru_opt.hpp"
//#include <functional>
...
class PGMCacheLO : public Competitor
{
...
public:
  ...
  {
    return "PGMCacheLO (" + std::to_string(pgm_.cacheHits) + ", " + std::to_string(pgm_.cacheTime) + ", " + std::to_string(pgm_.count) + ")";
  }
