#ifndef SOSDB_PGMCACHEL_H
#define SOSDB_PGMCACHEL_H
...
#include <iostream>
#include <algorithm>
#include "pgm_index_cache_lru_temp.hpp"
//#include <functional>
...
class PGMCacheL : public Competitor
{
...
public:
  ...
  {
    return "PGMCacheL (" + std::to_string(pgm_.cacheHits) + ", " + std::to_string(pgm_.cacheTime) + ", " + std::to_string(pgm_.count) + ")";
  }
