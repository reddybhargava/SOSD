#ifndef SOSDB_PGMCACHER_H
#define SOSDB_PGMCACHER_H
...
class PGMCacheR : public Competitor
{
...
public:
  ...
  {
    return "PGMCacheR (" + std::to_string(pgm_.cacheHits) + ", " + std::to_string(pgm_.cacheTime) + ", " + std::to_string(pgm_.count) + ")";
  }
